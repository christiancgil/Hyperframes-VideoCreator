...
const VOICE_ID = 'YPcWHXliBaqbvRa5Fcab'; // Luis
const OUTPUT_PATH = 'output/voiceover_luis_energetic.mp3';

const text = fs.readFileSync('output/voiceover_script.txt', 'utf8').trim();
const body = JSON.stringify({
  text,
  model_id: 'eleven_multilingual_v2',
  voice_settings: { stability: 0.30, similarity_boost: 0.80, style: 0.60, use_speaker_boost: true }
});
