...
const AUDIO_PATH  = path.join(BASE, 'output', 'video_completo_audio.mp3');
const OUTPUT_PATH = path.join(BASE, 'output', 'video_completo_transcript.json');
...
const req = https.request(options, res => {
  ...
  res.on('end', () => {
    ...
    console.log(`Palabras: ${json.words?.length}`);
    console.log(`\nTexto:\n${json.text}`);
    console.log('\nSegmentos:');
