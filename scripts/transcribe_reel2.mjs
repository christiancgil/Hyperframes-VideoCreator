...
const AUDIO_PATH  = path.join(BASE, 'output', 'reel2_audio.mp3');
const OUTPUT_PATH = path.join(BASE, 'output', 'reel2_transcript.json');
...
const req = https.request(options, res => {
  ...
  res.on('end', () => {
    ...
    console.log(`Transcript guardado: ${OUTPUT_PATH}`);
