...
const AUDIO_PATH  = path.join(BASE, 'output', 'censored2_audio.mp3');
const OUTPUT_PATH = path.join(BASE, 'output', 'censored2_transcript.json');
...
const req = https.request(options, (res) => {
  ...
  res.on('end', () => {
    ...
    console.log('Texto:', parsed.text?.substring(0, 120) + '...');
